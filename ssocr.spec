...
Version  : 2.25.0
Release  : 11
URL      : https://github.com/auerswal/ssocr/archive/v2.25.0/ssocr-2.25.0.tar.gz
Source0  : https://github.com/auerswal/ssocr/archive/v2.25.0/ssocr-2.25.0.tar.gz
...
%prep
%setup -q -n ssocr-2.25.0
cd %{_builddir}/ssocr-2.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743009181
