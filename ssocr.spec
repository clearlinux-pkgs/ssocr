...
Version  : 2.20.0
Release  : 3
URL      : https://github.com/auerswal/ssocr/archive/v2.20.0/ssocr-2.20.0.tar.gz
Source0  : https://github.com/auerswal/ssocr/archive/v2.20.0/ssocr-2.20.0.tar.gz
...
%prep
%setup -q -n ssocr-2.20.0
cd %{_builddir}/ssocr-2.20.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618954690
...
cp %{_builddir}/ssocr-2.20.0/COPYING %{buildroot}/usr/share/package-licenses/ssocr/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/ssocr-2.20.0/notdebian/copyright %{buildroot}/usr/share/package-licenses/ssocr/27ce10bb2e2cd714fa8c2ebc346853606c34e473
