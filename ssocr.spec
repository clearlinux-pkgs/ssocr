...
Version  : 2.22.0
Release  : 5
URL      : https://github.com/auerswal/ssocr/archive/v2.22.0/ssocr-2.22.0.tar.gz
Source0  : https://github.com/auerswal/ssocr/archive/v2.22.0/ssocr-2.22.0.tar.gz
...
%prep
%setup -q -n ssocr-2.22.0
cd %{_builddir}/ssocr-2.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636568237
...
cp %{_builddir}/ssocr-2.22.0/COPYING %{buildroot}/usr/share/package-licenses/ssocr/8624bcdae55baeef00cd11d5dfcfa60f68710a02
