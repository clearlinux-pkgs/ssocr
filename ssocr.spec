...
Version  : 2.23.1
Release  : 9
URL      : https://github.com/auerswal/ssocr/archive/v2.23.1/ssocr-2.23.1.tar.gz
Source0  : https://github.com/auerswal/ssocr/archive/v2.23.1/ssocr-2.23.1.tar.gz
...
%prep
%setup -q -n ssocr-2.23.1
cd %{_builddir}/ssocr-2.23.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684792350
